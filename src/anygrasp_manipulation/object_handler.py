...
mode_signal=[['arm', 'agv', 'stop'],[0, 1, 2]]
...
class ObjectHandler:
    ...
    def center_robot(self, bbox: Bbox):
        ...
        # base movement, dis is the depth distance to adjust
    ...
    def pickup(
        ...
        if self.cfgs.debug:
            ...
            print("translation", filter_gg[0].translation)
            print("rotation_matrix", filter_gg[0].rotation_matrix)
            print("depth and crop_flag",filter_gg[0].depth, crop_flag,0)
